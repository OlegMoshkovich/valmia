    ...
    columns: [
      {
        ...
        subtitle: "Helping residents and guests stay well informed.",
        items: ["Weather overview", "Snow & Nordic skiing reports", "Walking and hiking trail conditions", "Ski slope status"],
      },
      {
        title: "Events & Village Life",
        subtitle: "Making local activities and offerings more visible.",
        items: ["Events and gatherings in the village", "Club activities", "Cultural and seasonal occasions", "Municipal information"],
      },
      {
        title: "Community Exchange",
        subtitle: "Facilitating everyday exchange in the village.",
        items: ["Digital pinboard", "Marketplace for buying and selling", "Lost & Found", "Shared information exchange"],
      },
      {
        title: "Neighbourhood & Everyday Help",
        subtitle: "Encouraging mutual support in daily life.",
        items: ["Help requests (e.g. groceries for elderly residents, dog-sitting, etc.)", "Offering or requesting lifts", "Small everyday support", "Strengthening neighbourly solidarity"],
      },
      {
        title: "Local Network & Important Information",
        subtitle: "Central access to relevant contacts.",
        items: ["Local businesses and services", "Clubs and organisations", "Important contacts", "Municipal information"],
      },
    ],
  },
  de: {
    ...
    columns: [
      {
        title: "Örtliche Gegebenheiten und Orientierung",
        subtitle: "Hilft Bewohnern und Gästen, stets gut informiert zu bleiben.",
        items: ["Wetterübersicht", "Schnee- und Langlaufberichte", "Bedingungen zum Wandern und Spazieren", "Status der Skipisten"],
      },
      {
        title: "Veranstaltungen & Dorfleben",
        subtitle: "Macht lokale Aktivitäten und Angebote sichtbarer.",
        items: ["Veranstaltungen und Treffen im Dorf", "Vereinsaktivitäten", "Kulturelle und saisonale Anlässe", "Informationen der Gemeinde"],
      },
      {
        title: "Austausch in der Gemeinschaft",
        subtitle: "Erleichtert den alltäglichen Austausch im Dorf.",
        items: ["Digitale Pinnwand", "Marktplatz zum Kaufen und Verkaufen", "Fundbüro / Lost & Found", "Gemeinsamer Informationsaustausch"],
      },
      {
        title: "Nachbarschafts- und Alltagshilfe",
        subtitle: "Fördert gegenseitige Unterstützung im Alltag.",
        items: ["Hilfsanfragen (z. B. Einkäufe für ältere Bewohner, Hunde-Sitting, etc.)", "Mitfahrgelegenheiten anbieten oder suchen", "Kleine Unterstützung im Alltag", "Stärkung des nachbarschaftlichen Zusammenhalts"],
      },
      {
        title: "Lokales Netzwerk & wichtige Informationen",
        subtitle: "Zentraler Zugang zu relevanten Kontakten.",
        items: ["Lokale Unternehmen und Dienstleistungen", "Vereine und Organisationen", "Wichtige Kontakte", "Kommunale Informationen"],
      },
    ],
  },
};
